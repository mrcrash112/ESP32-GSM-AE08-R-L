...
function renderUpdateButton(update){const button=$('checkUpdate'),checking=Boolean(update.checking),downloading=Boolean(update.downloadQueued||update.downloading),installing=Boolean(update.approved||update.installing);button.disabled=checking||downloading||installing;button.textContent=checking?'Prüfung in Arbeit …':downloading?'Download in Arbeit …':installing?'Installation in Arbeit …':'Jetzt prüfen'}
