...
function fillForm(c){
  ...
  setChecked('mqttEnabled',c.mqtt.enabled);setValue('mqttBaseTopic',c.mqtt.baseTopic);setValue('mqttHost',c.mqtt.host);setValue('mqttPort',c.mqtt.port);setValue('mqttUser',c.mqtt.user);
